...
public class SpatialRelationBlock_Type extends Annotation_Type{
	@SuppressWarnings("hiding")
	public final static int typeIndexID = SpatialRelationBlock.typeIndexID;

	@SuppressWarnings("hiding")
	public final static boolean featOkTst = JCasRegistry
			.getFeatOkTst("edu.rosehulman.aixprize.pipeline.types.SpatialRelationBlock");
	...
	public double getId(int addr) {
		if (featOkTst && casFeat_id == null)
			jcas.throwFeatMissing("id", "edu.rosehulman.aixprize.pipeline.types.SpatialRelationBlock");
	...
	public String getName(int addr) {
		if (featOkTst && casFeat_name == null)
			jcas.throwFeatMissing("name", "edu.rosehulman.aixprize.pipeline.types.SpatialRelationBlock");
	 ...
	 *            Type
	 */
	public SpatialRelationBlock_Type(JCas jcas, Type casType) {
		super(jcas, casType);
